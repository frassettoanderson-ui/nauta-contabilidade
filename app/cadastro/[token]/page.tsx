...
// IMPORTANTE: definir fora do componente — se ficar dentro do render, o React
// remonta a subárvore a cada tecla e o input perde o foco após 1 caractere.
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Secao titulo="Acesso gov.br">
          ...
          <SmartField label="Senha do gov.br" type="text"
            value={senhaGov} onChange={v => setSenhaGov(v as string)} />
        </Secao>

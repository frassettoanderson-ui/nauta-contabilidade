...
const BENEFICIOS = [
  'Lançamento de receitas e despesas em um só lugar',
  'Aba de resumo com totais e saldo automáticos',
  'Categorias e formas de pagamento organizadas',
  'Funciona no Excel ou Google Sheets, sem instalar nada',
]

export default function PlanilhaControleFinanceiro() {
  return (
    <ToolShell
      crumb="Planilha de controle financeiro"
      titulo={<>Planilha de <span style={{ color: '#0BBCD4' }}>controle financeiro</span></>}
      descricao="Baixe grátis uma planilha para organizar as finanças da sua empresa ou pessoais, com resumo automático."
    >
      <Card>
        ...
        <a href="/planilhas/controle-financeiro.xlsx" download

...
<body>
  ...
  <div class="conteudo">
    ...
    ${Cl(3, '– DAS OBRIGAÇÕES DA CONTRATADA', `
      ...
      <p><b>3.1.</b> A CONTRATADA não se responsabilizará por multas, juros ou correções decorrentes da falta de recolhimento de obrigações, que correm por conta exclusiva da CONTRATANTE, assim como aquelas ocasionadas por falta de entrega de documentos ou por falhas nos sistemas do governo.</p>
      <p><b>3.2.</b> A CONTRATADA não assume responsabilidade pelas consequências de informações, declarações ou documentação inidôneas ou incompletas, nem por omissões da CONTRATANTE ou decorrentes do desrespeito à orientação prestada.</p>
      <p><b>3.3.</b> Os serviços terão por base o regime fiscal atual da CONTRATANTE (Simples Nacional, Lucro Presumido ou Lucro Real); havendo mudança de regime, as partes negociarão as alterações necessárias mediante termo aditivo próprio.</p>
      <p><b>3.3.1.</b> A CONTRATADA não se responsabilizará por obrigações acessórias vencidas ou vincendas no processo de transferência de responsabilidade técnica, as quais são de responsabilidade da empresa de contabilidade anterior.</p>
      <p><b>3.4.</b> A CONTRATADA compromete-se a cumprir os prazos da legislação, observando-se em especial:</p>
      <ul>

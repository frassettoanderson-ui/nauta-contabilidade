...
/** HTML do contrato, com layout profissional, conforme o tipo (derivado do interesse). */
export function buildContratoHtml(cliente: Obj, lead: Obj): string {
  ...
  // Assinaturas dos sócios (fiadores)
...
<style>
  @page { size: A4; margin: 2.4cm 2.2cm 2cm 2.2cm; }
  * { box-sizing: border-box; }
  body { font-family: 'Liberation Serif','Times New Roman',serif; font-size: 10.8pt; color: #1d1d22; line-height: 1.55; }

...
<body>
  ...
  <div class="conteudo">
    ...
    ${Cl(2, '– DAS OBRIGAÇÕES DA CONTRATANTE', `
      ...
      <p><b>2.8.</b> A CONTRATANTE obriga-se a manter seus dados de contato atualizados e a responder às comunicações e solicitações da CONTRATADA no prazo máximo de <b>10 (dez) dias úteis</b>. A ausência de retorno, de informações ou de documentos a cargo da CONTRATANTE <b>não suspende nem reduz</b> suas obrigações — em especial o pagamento dos honorários — e exime a CONTRATADA de responsabilidade por prazos, obrigações ou serviços não cumpridos em razão dessa inércia.</p>`)}
    ...
    ${Cl(5, '– DOS HONORÁRIOS PROFISSIONAIS', `
      ...
      <p><b>5.4.1.</b> Persistindo a inadimplência, a CONTRATADA fica expressamente autorizada, a seu exclusivo critério, a promover o <b>protesto do débito em cartório</b> e a <b>inscrição do nome da CONTRATANTE e/ou de seus sócios fiadores nos órgãos de proteção ao crédito</b> (Serasa, SPC e congêneres), sem prejuízo da cobrança judicial ou extrajudicial do valor devido, acrescido dos encargos previstos na cláusula 5.4, e das demais penalidades deste contrato.</p>
      ...
      <p><b>5.10.</b> Os honorários mensais são devidos a partir da <b>assinatura</b> deste contrato e por toda a sua vigência, <b>ainda que os serviços fiquem parcial ou totalmente paralisados</b> por falta de envio de informações, documentos, resposta ou de qualquer providência a cargo da CONTRATANTE. O silêncio, a indisponibilidade ou a inércia da CONTRATANTE não a desobrigam do pagamento, permanecendo os honorários integralmente exigíveis pela CONTRATADA.</p>`)}
    ...
    ${Cl(7, '– DA VIGÊNCIA, RESCISÃO E TRANSFERÊNCIA', `
      ...
      <p><b>7.5.</b> <b>Inércia / abandono pela CONTRATANTE.</b> A ausência de retorno da CONTRATANTE às comunicações da CONTRATADA, ou a falta de envio de informações, documentos ou providências a seu cargo, por período igual ou superior a <b>60 (sessenta) dias</b>, que impossibilite ou paralise o andamento dos serviços, será considerada abandono contratual. Nessa hipótese, faculta-se à CONTRATADA rescindir o contrato e exigir os honorários vencidos até a efetiva rescisão, acrescidos da multa prevista na cláusula 7.4, sem prejuízo das demais medidas de cobrança. A paralisação por inércia da CONTRATANTE não suspende nem reduz a exigibilidade dos honorários no período.</p>
      ${fidelidadeClausula}`)}
    ...
    <ul>
      ...
      <li>Parcelamento de débitos tributários (Federais, Estaduais e Municipais), incluído nos honorários;</li>

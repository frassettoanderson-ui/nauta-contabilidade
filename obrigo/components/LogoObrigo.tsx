// Logo do Obrigo: marca (icone de checklist/documento com canto dobrado) + wordmark.
// variant 'light' = para fundos escuros (sidebar/login); 'dark' = para fundos claros.
...
export default function LogoObrigo({
  size = 30,
  showText = true,
  variant = 'light',
  className = '',

...
// Dentro da Nauta o modulo Obrigo fala com a API do Obrigo servida no mesmo dominio (/gestoroa/api/v1).
const BASE = `${(process.env.NEXT_PUBLIC_OBRIGO_BASE ?? '/gestoroa').replace(/\/$/, '')}/api/v1`;

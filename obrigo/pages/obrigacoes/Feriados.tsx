...
export default function Feriados() {
  ...
  const visiveis = lista; // rola e mostra todos (feriados ja vem completos do backend)
  ...
  return (
    <div className="-m-6 min-h-full bg-fundo p-4 text-[13px]">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="flex-1 text-center text-[13px] font-medium text-marca-600">Listando {lista.length} registros:</div>
        {podeGerenciar && (

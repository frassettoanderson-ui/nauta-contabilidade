      ...
      <div className="mt-6 rounded border border-slate-200 bg-white p-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <p className="mt-1 text-[11px] text-slate-400">Dica: 3+ termos do cabeçalho deixam a identificação mais segura.</p>
          </div>
          <div>
            <label className={LBL}>Palavras de exclusão (uma por linha — se aparecer, NÃO casa)</label>
            <textarea className={`${INP} font-mono`} rows={4} value={exclusoes} onChange={(e) => setExclusoes(e.target.value)} placeholder={'Recibo de Pagamento\nRecibo de Salario'} />
            <p className="mt-1 text-[11px] text-slate-400">Evita falso-positivo (ex.: FGTS excluir "Recibo de Pagamento").</p>
          </div>
